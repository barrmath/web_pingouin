...
def ia_result (specie,bill_length_mm,bill_depth_mm,flipper_length_mm,body_mass_g):
    ...
    IA_test = joblib.load('pingouin_app' + url_for('static',filename = 'model_IA/reg_log_pingouin.pkl'))
    #scaler = joblib.load('static/model_IA/label/scaler.pkl')
    scaler = joblib.load('pingouin_app' +url_for('static',filename = 'model_IA/label/scaler.pkl'))
    #label_sex = joblib.load('static/model_IA/label/label_sex.pkl')
    label_sex = joblib.load('pingouin_app' + url_for('static',filename = 'model_IA/label/label_sex.pkl'))
    #label_specie = joblib.load('static/model_IA/label/label_species.pkl')
    label_specie = joblib.load('pingouin_app' + url_for('static',filename = 'model_IA/label/label_species.pkl'))
    ...
    dico_pingouin = {'species' : specie, 'bill_length_mm' : bill_length_mm
    ...
    test[['bill_length_mm','bill_depth_mm','flipper_length_mm','body_mass_g']] = (scaler.transform(test[['bill_length_mm'
                                                                                                         ,'bill_depth_mm'
                                                                                                         ,'flipper_length_mm'
                                                                                                         ,'body_mass_g']]))
